...
<!-- 답글 작성이 가능한 유저라면 -->
<c:if test="${isReplyUser eq true}">

<div align="right">
<input type="button" id="reply" value="답글쓰기" class="btn"/>
</div>

<script type="text/javascript">
document.getElementById("reply").onclick = function() {
	location.href = "inquiryReply.do?no=${param.no}";
}
</script>
...
document.getElementById("delete").onclick = function() {
	if(confirm("정말 삭제하시겠습니까?")) {
		location.href = "deleteInquiry.do?no=${param.no}";
	}
}
</script>
</c:if>
