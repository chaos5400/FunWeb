...
<!-- 글 제목 선택시 이동할 글 -->
<c:set var="readPage" value="noticeRead.do" scope="request" />

<!-- 페이지 목록에서 페이지 클릭시 이동할 페이지 -->
<c:set var="listPage" value="notice.do" scope="request" />
...
<!-- 글쓰기 버튼 클릭시 사용할 변수 -->
<c:set var="writeDo" value="noticeWrite.do" scope="request"/>
